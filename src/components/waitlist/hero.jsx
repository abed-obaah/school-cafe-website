...
const NewsSection = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between bg-blue-100 p-8 lg:p-10 rounded-xl max-w-7xl mx-auto mt-10">
      <div className="max-w-xl px-4 lg:px-20 space-y-10 order-2 lg:order-first mt-5">
      ...
      <div className="w-64 h-64 lg:w-80 lg:h-80 mt-6 lg:mt-0 order-1 lg:order-last mb-5">
