    ...
    const featuredSchools = [
      ...
      const SchoolCard = ({ school }) => (
        <div className="border border-gray-300 mt-4 p-4 rounded-lg ">
          ...
          <p className="mt-2 text-sm text-gray-600">{school.description} <a href="#" className="text-blue-500 text-sm mt-2 block">Read More.....</a></p>
          <div className="flex space-x-4 mt-2 text-sm text-gray-500">
            <span className="inline-flex items-center rounded-md bg-[#DBEFFF] px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">👁️ {school.views} Views</span>
            <span className="inline-flex items-center rounded-md bg-[#DBEFFF] px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">👍 {school.likes} Likes</span>
            <span className="inline-flex items-center rounded-md bg-[#DBEFFF] px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">🔗 Share</span>
          </div>
          {/* <a href="#" className="text-blue-500 text-sm mt-2 block">Read More.....</a> */}
        </div>
      );
  ...
  return (
    <div>
                    <div className="flex  bg-white px-4 py-5 sm:px-6 justify-between">
                                ...
                                {/* Right section with fixed height */}
                                          <div className="w-3/6 bg-[#DBEFFF] p-4 rounded-lg h-96 overflow-auto"> 
                                            {/* Fixed height of 96 (approx 24rem) and scrollable content if overflow */}
                    ...
                    <div className="w-3/6 bg-[#DBEFFF] p-4 rounded-lg  overflow-auto h-[200px] "> 
                      <div className="mt-0">
                        <div className="flex justify-between">
      ...
      <div className="w-1/2 flex flex-col">
        <div className="flex justify-between border-b border-gray-200">
          <h3 className="text-base font-semibold leading-6 text-gray-900">Admission Process</h3>
          <FaCaretUp className="h-5 w-5 text-gray-400" aria-hidden="true" />
        </div>
        <div className="mt-2">
          <p className='text-[#00172A] font-light'>
          ...
          <p className='mt-10 text-[#00172A] font-light text-[15px]'>
            ...
            <span className='text-[#1D7BC7] font-bold'> Read More....</span>
                  ...
                  <div className="w-1/2 flex flex-col">
                    <div className="flex justify-between border-b border-gray-200">
                      <h3 className="text-base font-semibold leading-6 text-gray-900">School Fees & Dues</h3>
                      <FaCaretUp className="h-5 w-5 text-gray-400" aria-hidden="true" />
                    </div>
                    <div className="mt-2">
                      <p className='text-[#00172A] font-light'>
                      Delta State University lowest school fees starts NGN150,000 University located in Abraka with a lot of attractive tourist sites including the alluring blue coloured River Ethiope acclaimed to be the depest Inland Waterway in Africa.
                      </p>
                      <p className='mt-10 text-[#00172A] font-light text-[15px]'>
                        DELSU was established with the mandate of building diverse human 
                        <span className='text-[#1D7BC7] font-bold'> Read More....</span>
