        ...
        <div key={index} className="border border-gray-200 mb-2 rounded-md">
          ...
          >
            <div className="flex justify-between items-center">
                        ...
                        <Link to={item.link}>
                         <button className="bg-[#1D7BC7] w-[200px] py-2.5 mr-5 rounded-md text-white">View</button>
                        </Link>
                       
                        </div>
            <div className="flex justify-between items-center">
                        <p className="p-5 text-gray-600">{item.content1}</p>
                        {/* <Link to={item.link}> */}
                        <button className="bg-[#1D7BC7] w-[200px] py-2.5 mr-5 rounded-md text-white">Views</button>
                        {/* </Link> */}
                        </div>
