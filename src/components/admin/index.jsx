                  ...
                  <div className="w-full max-w-lg lg:max-w-xs">
                    ...
                    <div className="relative text-gray-400 focus-within:text-gray-600">
                      ...
                      <input
                        ...
                        type="search"
                        placeholder="Search"
                        className="block w-full rounded-md border-0 bg-white py-1.5 pl-10 pr-3 text-gray-900 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 sm:text-sm/6"
                      />
                    </div>
                  </div>
                </div>
